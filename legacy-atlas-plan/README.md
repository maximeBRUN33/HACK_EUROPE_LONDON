# Legacy Atlas Planning Package

This folder is the execution-grade planning package for the Legacy Atlas hackathon build.

Use documents in this order:

1. `01-strategy-and-decisions.md`
2. `02-architecture-and-data-model.md`
3. `03-delivery-roadmap.md`
